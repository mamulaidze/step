...
-- ყველა შეყვანილის ინფორმაციის ნახვა
SELECT * FROM cars;

-- კონკრეტული ინფორმაციის წამოღება
SELECT brand, release_year, price
FROM cars;

-- კონკრეტული ინფორმაციის მიხედვით მაგ:
